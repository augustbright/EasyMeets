...
struct EventModel: Identifiable {
    ...
    static var mock = EventModel(id: "id1", dateCreated: nil, authorId: "ErWgEodvZnMgQ20MDgR0", authorName: "Pushkin",  startDate: "2023-01-05T18:54:19Z", longtitude: 44.802095, latitude:  41.715137, locationAdditionalInfo: "Station square", description: "An awesome event", deleted: false, peopleAttending: [])
}
